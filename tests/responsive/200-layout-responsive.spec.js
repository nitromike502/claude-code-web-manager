...
for (const [deviceType, viewport] of Object.entries(viewports)) {
  test.describe(`Responsive Design - ${viewport.name}`, () => {
    ...
    test('Navigation to project detail works', async ({ page }) => {
    ...
    test('Project detail layout adapts correctly', async ({ page }) => {
    ...
    test('Sidebar behavior adapts to screen size', async ({ page }) => {
      // Navigate to project detail
      const projectCards = page.locator('.project-card:not(.user-card)');
      const cardCount = await projectCards.count();
    ...
    test('User view layout adapts correctly', async ({ page }) => {
    ...
    test('Scrolling works properly', async ({ page }) => {
    ...
    test('Screen captures for visual verification', async ({ page }) => {
...
test.describe('Responsive Design - Cross-Viewport Tests', () => {
  ...
  test('Content remains accessible during viewport changes', async ({ page }) => {
    await page.goto('/');
    await waitForAppReady(page);
